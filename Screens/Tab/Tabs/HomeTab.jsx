...
export default function HomeTab() {
  ...
  const fetchMyDetails = async () => {
    try {
      setLoad(true);
      const querySnapshot = await getDoc(doc(db, 'students', auth.currentUser?.uid));
  ...
  const quickServices = [
    { id: '1', name: 'Attendance', icon: 'check-circle', color: '#075eec', click: () => { console.log(MyDetails) } },
    { id: '2', name: 'Timetable', icon: 'calendar-alt', color: '#12c7ed' },
    { id: '3', name: 'E-books', icon: 'book', color: '#168fc2' },
    { id: '4', name: 'Exam Schedule', icon: 'file-alt', color: '#f2a900' },
    { id: '5', name: 'Events & Notices', icon: 'bullhorn', color: '#ff5722' },
    { id: '6', name: 'Clubs', icon: 'users', color: '#9c27b0' },
    { id: '7', name: 'Gallery', icon: 'images', color: '#2196f3' },
    { id: '8', name: 'Fee Payment', icon: 'money-bill-wave', color: '#ff9800' },
    { id: '9', name: 'Student Support', icon: 'hands-helping', color: '#e91e63' },
    { id: '10', name: 'Contact HOD', icon: 'phone', color: '#607d8b' },
  ];
      ...
      <View style={styles.premiumProfileHeader}>
        <View style={styles.profileRow}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.premiumWelcomeText}>Welcome, {MyDetails.fullName}!</Text>
